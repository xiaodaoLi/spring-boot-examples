...
public class JaxWsDynamicClientFactoryClientTest {
    public static void main(String[] args) {
        String address = "http://localhost:31010/services/UserSsoService?wsdl";
//        String address = "http://localhost:31010/services/UserSsoService";
        // 对方提供的，有笔误的
...
//        String method = "getSsoBySessionToken";
        ...
        log.info("resultMap = {}", JSON.toJSONString(resultMap, JSONWriter.Feature.PrettyFormat));
        // 返回手机号码
